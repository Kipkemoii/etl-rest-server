...
const claimsSummaryPatientListCols = require('../../app/reporting-framework/json-reports/claims-summary/claims-summary-patient-list-columns');

export class ClaimsDashboardSummaryService extends MultiDatasetPatientlistReport {
    ...
    return new Promise((resolve, reject) => {
      super
        ...
        .then((results) => {
          ...
          results['patientListCols'] = claimsSummaryPatientListCols;
